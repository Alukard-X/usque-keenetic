...
На устройстве будет запущен SOCKS5 сервер на порту 8480 (например 192.168.1.1:8480)
...
rm /opt/usr/bin/usque /opt/etc/usque/config.json /opt/etc/init.d/S99usque
```
